...
def cotp(payload, len):
    cotp_header = bytes.fromhex("03 00")
    payload_len = len.to_bytes(2, byteorder="big")
    pkt = cotp_conreq_pkt_ + payload
    return pkt


print(cotp(bytes.fromhex("11 e0 0000 0001 00 c0 01 0a c1 02 0100 c2 02 0301"), 22))
